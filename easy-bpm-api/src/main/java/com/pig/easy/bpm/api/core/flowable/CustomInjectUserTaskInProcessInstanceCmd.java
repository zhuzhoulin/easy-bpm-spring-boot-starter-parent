...
public class CustomInjectUserTaskInProcessInstanceCmd extends AbstractDynamicInjectionCmd implements Command<Void> {
    ...
    @Override
    protected void updateBpmnProcess(CommandContext commandContext, org.flowable.bpmn.model.Process process,
...
//                extensionAttribute.setNamespacePrefix("flowable");
            ...
            incomingFlow.setId(dynamicUserTaskBuilder.nextFlowId(process.getFlowElementMap()));
            recordNewSequence(commandContext,incomingFlow,currentFlowElemet.getExtensionId(),originalProcessDefinitionEntity.getId());
